...
public class AuthService : IAuthService
{
    ...
    public AuthService(UserManager<LocalUser> userManager, RoleManager<IdentityRole> roleManager, IOptions<JWT> jwt)
    {
    ...
    private async Task<JwtSecurityToken> CreateJwtToken(LocalUser user)
    {
