        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewsRating = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckInDateUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CheckOutDateUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            {
                migrationBuilder.Sql("IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='AspNetRoles' AND xtype='U') BEGIN CREATE TABLE AspNetRoles (...); END");
            }
        }
